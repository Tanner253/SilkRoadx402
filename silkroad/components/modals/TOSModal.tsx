    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl rounded-xl border border-purple-900/50 bg-[#0f0f14] p-6 shadow-2xl shadow-purple-900/20 mx-4">
        ...
        >
          ...
          <p className="mb-4">
            Full platform access requires holding ≥50,000 $SR tokens in your wallet. The platform checks your balance on Solana mainnet. Insufficient balance restricts functionality.
          </p>
          ...
          <button
            ...
            className={`rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors ${
              hasScrolled && !accepting
                ? 'bg-[#F97316] hover:bg-[#ea6c0e] cursor-pointer'
